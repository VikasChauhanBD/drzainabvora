    ...
    <div className="feedback-section">
      ...
      <div className="feedback-container">
        <div className="feedback-column column-1">
          <div className="feedback-track feedback-track-up">
        ...
        <div className="feedback-column column-2">
          <div className="feedback-track feedback-track-down">
        ...
        <div className="feedback-column column-3">
          <div className="feedback-track feedback-track-up">
        ...
        <div className="feedback-fog-overlay feedback-fog-top"></div>
        <div className="feedback-fog-overlay feedback-fog-bottom"></div>
      </div>
