...
<li>There will be no abrupt changes.</li>
...
<li>There is no loss of access.</li>
  ...
  },
  {
    ...
    answer: `All students who have already subscribed to or will subscribe to mission programs (FMG or NEET/INICET) till <strong>March 31, 2027</strong>:
<ul>
...
<li>Do not need to repurchase the course till course validity.</li>
  ...
  },
  {
    ...
    answer: `Hardcopy notes already provided with BTR package are sufficient for studying with BTR 2.0 videos. If students want to follow the new version of BTR videos, they may:
<ul>
...
<li>Purchase updated notes separately.</li>
  ...
  },
  {
    ...
    answer: `Yes, BTR 2.0 notes can be purchased from the Cerebellum App until <strong>31 March 2026</strong>. However:
<ul>
...
<li>Students planning to follow the new BTR version should wait and purchase notes from the new platform after April.</li>
  ...
  },
  {
    ...
    answer: `Yes, students are advised to purchase the Mission subscription before <strong>31 March 2026</strong> if they want BTR included within the Mission plan.<br/><br/>If a student purchases the Mission subscription <strong>on or before 31 March 2026</strong>, they will receive BTR access as part of the Mission subscription according to the applicable terms.<br/><br/>However, if the Mission subscription is purchased <strong>after 31 March 2026</strong>, BTR will no longer be included in the Mission plan. In that case, students who want BTR will need to purchase the BTR subscription separately from Dr. Zainab Vora's new App.`,
  },
  {
    id: 12,
  ...
  },
  {
    ...
    answer: `<strong>Preparation.</strong> All academic commitments are intact. There is no loss of access. There is no disruption of schedule.`,
  },
  {
    id: 16,
...
<ul>
<li><strong>A new Ultra High Revision Program</strong>
  <ul>
...
All other academic systems remain unchanged.`,
  ...
  {
    id: 19,
    question: "Will FMG or NEET PG 2026 preparation be affected?",
    answer: `No.
<ul>
...
<li><strong>From April 2, 2026:</strong> Remaining validity of BTR online shifts to new app.</li>
  ...
  },
  {
    ...
    answer: `Cerebellum mission and BTR subscribers need to give consent for sending necessary details to the new platform for subscription. The option for this consent will be provided within the Cerebellum Academy App before <strong>20th March 2027</strong>. Students then need to download Dr. Zainab's new App when it launches and login using these credentials. The subscription will then be automatically activated.`,
  },
  {
    id: 22,
    question:
  ...
  },
  {
    ...
    answer: `No. Recorded videos of Radiology and BTR will be available on Cerebellum App till the duration of your subscription. Scheduled live sessions of Radiology as well as BTR till <strong>March 31, 2026</strong> will be conducted at Cerebellum App. Live sessions of Dr. Zainab after March 31, 2026 will be conducted on the new App.`,
  },
  {
    id: 25,
    question:
